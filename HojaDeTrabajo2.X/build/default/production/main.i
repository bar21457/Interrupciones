...
MAIN:
    ...
    BSF OSCCON, 6 ; ((OSCCON) and 07Fh), 6 Selección de 2MHz
    ...
    BSF WPUB, 0
    BSF WPUB, 1 ; Habilitando los pull-ups en ((PORTB) and 07Fh), 0 y ((PORTB) and 07Fh), 1
    ...
    BCF OPTION_REG, 3 ; ((OPTION_REG) and 07Fh), 3: Se asigna el Prescaler al TMR0

    BSF OPTION_REG, 2
    BSF OPTION_REG, 1
    BCF OPTION_REG, 0 ; ((OPTION_REG) and 07Fh), 2 -0: Prescaler 1:128
